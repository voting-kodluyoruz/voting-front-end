...
const useStyles = makeStyles((theme) => ({
  root: {
    ...
    borderRadius: 15,
    "&:hover": {
      boxShadow: "0 4px 2px 0px rgba(0,0,0,0.8)",
    },
  },
  details: {
    display: "flex",
...
const PopularCompaniesCard = (props) => {
              ...
              <Grid item>
                ...
                <div className={classes.controls}>
                  <Box component="fieldset" mb={3} borderColor="transparent">
                    <Typography component="legend">{t("PopularCompanies.stars")}</Typography>
                    <Rating
                      size="large"
                      name="read-only"
                      readOnly
